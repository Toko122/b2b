...
const DistributorSignUp = () => {
  return (
    ...
    <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Sign Up As Distributor</h2>
    ...
    <p class="text-center mt-4">Already have an account? <Link to='/login/distributorlogin' class="text-blue-500 underline">Log In</Link></p>
</form>
    </div>
</div>
  )
